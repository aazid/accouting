            ...
            <div style={{ display: 'grid', gridTemplateColumns: '260px 1fr', gap: '32px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    <div style={{ marginTop: '20px', padding: '16px', background: '#fefce8', borderRadius: '12px', border: '1px solid #fde047' }}>
                        <p style={{ fontSize: '11px', fontWeight: 'bold', color: '#854d0e', marginBottom: '4px' }}>PRO TIP: CLOUD SYNC</p>
                        <p style={{ fontSize: '10px', color: '#854d0e' }}>Your data is automatically synced to the Django cloud whenever you make changes.</p>
                    </div>
                </div>
                                ...
                                <div style={{ marginTop: '32px', padding: '24px', background: 'var(--bg-main)', borderRadius: '16px', border: '1px solid var(--primary-light)' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '12px' }}>
                                        <button
                                            ...
                                            onClick={() => {
                                                dispatch({ type: 'SET_USER', payload: { id: 'u1', email: 'admin@arthik.com', username: 'admin', role: 'Admin' } });
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                dispatch({ type: 'SET_USER', payload: { id: 'u2', email: 'acc@arthik.com', username: 'accountant', role: 'Accountant' } });
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                dispatch({ type: 'SET_USER', payload: { id: 'u3', email: 'staff@arthik.com', username: 'staff', role: 'Staff' } });
